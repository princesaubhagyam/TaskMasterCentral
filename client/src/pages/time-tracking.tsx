              ...
              <div className="flex items-center">
                <div className="text-right mr-6">
                  ...
                  {isLoading ? (
                    ...
                    <p className={`mt-1 text-sm font-medium ${isClockedIn ? "text-green-600" : "text-gray-500"}`}>
              ...
              {isLoadingEntries ? (
                ...
                <>
                  ...
                  <div className="flex flex-col items-center p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="mt-2 text-3xl font-bold text-gray-900">{stats.todayHours.toFixed(1)}</div>
                  ...
                  <div className="flex flex-col items-center p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="mt-2 text-3xl font-bold text-gray-900">{stats.weekHours.toFixed(1)}</div>
                    <div className="mt-1 text-sm text-gray-500">hours</div>
                  </div>
                  ...
                  <div className="flex flex-col items-center p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="mt-2 text-3xl font-bold text-gray-900">{stats.monthHours.toFixed(1)}</div>
                    <div className="mt-1 text-sm text-gray-500">hours</div>
                  </div>
                  ...
                  <div className="flex flex-col items-center p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="mt-2 text-3xl font-bold text-gray-900">{stats.overtimeHours.toFixed(1)}</div>
                    <div className="mt-1 text-sm text-gray-500">hours</div>
                  </div>
                </>
              )}

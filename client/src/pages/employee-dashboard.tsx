        ...
        <Card className="bg-white shadow overflow-hidden">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-medium text-gray-900">Time Tracking Status</h2>
              {!isLoadingTimeData && (
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
              {isLoadingTimeData ? (
                ...
                <>
                  ...
                  {/* Weekly Hours */}
                  <div className="flex flex-col items-center p-4 bg-gray-50 rounded-lg">
                    <div className="text-sm font-medium text-gray-500">Weekly Hours</div>
                    <div className="mt-2 text-3xl font-bold text-gray-900">{stats.weekHours.toFixed(1)}</div>
                    <div className="mt-1 text-sm text-gray-500">of 40 hours</div>
                  </div>
